...
{
    public class CreateMedicalRecordDtoRequestValidator : AbstractValidator<CreateMedicalRecordDtoRequest>
    {
        public CreateMedicalRecordDtoRequestValidator()
        {
            RuleFor(x => x.AppointmentId).RequiredRule("AppointmentId");
